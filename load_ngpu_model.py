...
lora_model_dir = "/root/dyl/demo/ChatGLM6b_finetuning/output_dir_lora_ngpu"
model = AutoModel.from_pretrained(original_model_dir, trust_remote_code=True).half().to("cuda:1")
...
# model = model.load_state_dict(torch.load(lora_model_dir))
